...
a,b){if(null!=e)if(r&&e.forEach===r)e.forEach(a,b);else if(e.length===+e.length)for(var k=0,d=e.length;k<d&&!(k in e&&a.call(b,e[k],k,e)===c);k++);else for(k in e)if(h.has(e,k)&&a.call(b,e[k],k,e)===c)break};h.map=h.collect=function(a,b,c){var k=[];if(null==a)return k;if(m&&a.map===m)return a.map(b,c);s(a,function(a,e,d){k[k.length]=b.call(c,a,e,d)});a.length===+a.length&&(k.length=a.length);return k};h.reduce=h.foldl=h.inject=function(a,b,c,k){var d=2<arguments.length;null==a&&(a=[]);if(u&&a.reduce===
u)return k&&(b=h.bind(b,k)),d?a.reduce(b,c):a.reduce(b);s(a,function(a,e,f){d?c=b.call(k,c,a,e,f):(c=a,d=!0)});if(!d)throw new TypeError("Reduce of empty array with no initial value");return c};h.reduceRight=h.foldr=function(a,b,c,k){var d=2<arguments.length;null==a&&(a=[]);if(v&&a.reduceRight===v)return k&&(b=h.bind(b,k)),d?a.reduceRight(b,c):a.reduceRight(b);var f=h.toArray(a).reverse();k&&!d&&(b=h.bind(b,k));return d?h.reduce(f,b,c,k):h.reduce(f,b)};h.find=h.detect=function(a,b,c){var k;F(a,function(a,
...
(function(){var b=this,a=b.Backbone,g=Array.prototype.slice,c=Array.prototype.splice,d;d="undefined"!==typeof exports?exports:b.Backbone={};d.VERSION="0.9.2";var f=b._;!f&&"undefined"!==typeof require&&(f=require("underscore"));var l=b.jQuery||b.Zepto||b.ender;d.setDomLibrary=function(a){l=a};d.noConflict=function(){b.Backbone=a;return this};d.emulateHTTP=!1;d.emulateJSON=!1;var p=/\s+/,n=d.Events={on:function(a,b,c){var d,f,e,g,h;if(!b)return this;a=a.split(p);for(d=this._callbacks||(this._callbacks=
{});f=a.shift();)e=(h=d[f])?h.tail:{},e.next=g={},e.context=c,e.callback=b,d[f]={tail:g,next:h?h.next:e};return this},off:function(a,b,c){var d,g,e,h,l,m;if(g=this._callbacks){if(!a&&!b&&!c)return delete this._callbacks,this;for(a=a?a.split(p):f.keys(g);d=a.shift();)if(e=g[d],delete g[d],e&&(b||c))for(h=e.tail;(e=e.next)!==h;)if(l=e.callback,m=e.context,b&&l!==b||c&&m!==c)this.on(d,l,m);return this}},trigger:function(a){var b,c,d,f,e,h;if(!(d=this._callbacks))return this;e=d.all;a=a.split(p);for(h=
...
b?"":""+b)},has:function(a){return null!=this.get(a)},set:function(a,b,c){var d,g;f.isObject(a)||null==a?(d=a,c=b):(d={},d[a]=b);c||(c={});if(!d)return this;d instanceof t&&(d=d.attributes);if(c.unset)for(g in d)d[g]=void 0;if(!this._validate(d,c))return!1;this.idAttribute in d&&(this.id=d[this.idAttribute]);b=c.changes={};var e=this.attributes,h=this._escapedAttributes,l=this._previousAttributes||{};for(g in d){a=d[g];if(!f.isEqual(e[g],a)||c.unset&&f.has(e,g))delete h[g],(c.silent?this._silent:
...
a.error=d.wrapError(a.error,b,a);return(this.sync||d.sync).call(this,"read",this,a)},save:function(a,b,c){var g,h;f.isObject(a)||null==a?(g=a,c=b):(g={},g[a]=b);c=c?f.clone(c):{};if(c.wait){if(!this._validate(g,c))return!1;h=f.clone(this.attributes)}a=f.extend({},c,{silent:!0});if(g&&!this.set(g,c.wait?a:c))return!1;var e=this,l=c.success;c.success=function(a,b,d){b=e.parse(a,d);c.wait&&(delete c.wait,b=f.extend(g||{},b));if(!e.set(b,c))return!1;l?l(e,a):e.trigger("sync",e,a,c)};c.error=d.wrapError(c.error,
e,c);b=this.isNew()?"create":"update";b=(this.sync||d.sync).call(this,b,this,c);c.wait&&this.set(h,a);return b},destroy:function(a){a=a?f.clone(a):{};var b=this,c=a.success,g=function(){b.trigger("destroy",b,b.collection,a)};if(this.isNew())return g(),!1;a.success=function(d){a.wait&&g();c?c(b,d):b.trigger("sync",b,d,a)};a.error=d.wrapError(a.error,b,a);var h=(this.sync||d.sync).call(this,"delete",this,a);a.wait||g();return h},url:function(){var a=B(this,"urlRoot")||B(this.collection,"url")||G();
...
this._reset();this.initialize.apply(this,arguments);a&&this.reset(a,{silent:!0,parse:b.parse})};f.extend(r.prototype,n,{model:t,initialize:function(){},toJSON:function(a){return this.map(function(b){return b.toJSON(a)})},add:function(a,b){var d,g,h,e,l,m={},q={},p=[];b||(b={});a=f.isArray(a)?a.slice():[a];d=0;for(g=a.length;d<g;d++){if(!(h=a[d]=this._prepareModel(a[d],b)))throw Error("Can't add an invalid model to a collection");e=h.cid;l=h.id;m[e]||this._byCid[e]||null!=l&&(q[l]||this._byId[l])?
p.push(d):m[e]=q[l]=h}for(d=p.length;d--;)a.splice(p[d],1);d=0;for(g=a.length;d<g;d++)(h=a[d]).on("all",this._onModelEvent,this),this._byCid[h.cid]=h,null!=h.id&&(this._byId[h.id]=h);this.length+=g;c.apply(this.models,[null!=b.at?b.at:this.models.length,0].concat(a));this.comparator&&this.sort({silent:!0});if(b.silent)return this;d=0;for(g=this.models.length;d<g;d++)if(m[(h=this.models[d]).cid])b.index=d,h.trigger("add",h,this,b);return this},remove:function(a,b){var c,d,g,e;b||(b={});a=f.isArray(a)?
...
var Routes={routes:{recommend:"recommend",decline:"decline",complete:"complete",place:"place",schedule:"schedule","*actions":"invitation"}},Views={},Behaviors={},App={params:{os_offset:0,foursquare:{client_id:"4SIMQ4JDF4JFUKV1XY52C1UB4ZBOJNX5XSXT3YUF2UNBP10N"}},reply:{timeslots:{},location:{}},initialize:function(){"iPhone"==Env.device.device&&7>Env.device.version&&(this.params.os_offset=60);this.intercept_foursquare_token();var b=window.location.hash.replace("#","");b in Routes.routes&&(window.localStorage&&
window.localStorage.getItem("current_meeting"))&&(b=window.localStorage.getItem("current_meeting"));window.localStorage&&window.localStorage.getItem("meeting_"+b)?(App.meeting=JSON.parse(window.localStorage.getItem("meeting_"+b)),window.localStorage.getItem("reply_"+b)&&(App.reply=JSON.parse(window.localStorage.getItem("reply_"+b))),App.launch()):0<b.length?(App.loader(),App.api.request("get@meetings/"+b,{success:function(){App.save_meeting(this)}})):$("#wrapper").append($(Templates.error).html())},
save_meeting:function(b){200==b.code?(App.meeting=b.data,window.localStorage&&(window.localStorage.setItem("meeting_"+App.meeting.id,JSON.stringify(b.data)),window.localStorage.setItem("current_meeting",App.meeting.id)),App.launch()):$("#wrapper").append($(Templates.error).html());App.end_loading()},save_reply:function(){window.localStorage.setItem("reply_"+App.meeting.id,JSON.stringify(App.reply))},launch:function(){Nav.initialize({remove_views:!1,no_access_animation:"slide",ui_delay:500})},before_transition:function(){Nav.view.requests=
[];App.resize();$.fn.placeholder&&Nav.view.$el.find("input[type=text], input[type=date], input[type=password], textarea").placeholder()},after_transition:function(){Nav.elmt.css({height:Nav.view.$el.height()})},before_unload:function(){Nav.view.requests&&App.cancel_requests()},send_reply:function(b){App.loader();App.api.request("put@meetings/"+App.meeting.id,{data:App.reply,success:function(){204==this.code&&b()}})},cancel_requests:function(){for(var b=0;b<Nav.view.requests.length;b++)Nav.view.requests[b].abort();
Nav.view.refreshing=!1;Nav.view.requests=[]},resize:function(){0<App.params.os_offset&&(Ui.min_height=$(window).height()+App.params.os_offset,App.params.os_offset=0);var b=Nav.elmt.is("#wrapper")?$("header").height():0,a=App.get_auto_height(Nav.view.$el),g=App.get_auto_height(Nav.elmt);a+b+App.params.os_offset<Ui.min_height?Nav.view.$el.css({height:Ui.min_height-b+App.params.os_offset}):Nav.view.$el.css({height:a});b=[a,g,$(window).height()];Nav.current_transition&&b.push(Nav.current_transition.prev_view.$el.height());
b=_.max(b);Nav.elmt.css({height:b})},reset_and_resize:function(){Nav.elmt.css({height:"auto"});Nav.view.$el.css({height:"auto"});Nav.run("resize")},get_auto_height:function(b){var a=b.clone();a.css({visibility:"hidden",height:"auto"});b.after(a);b=a.height();a.remove();return b},loader:function(){$.scrollTop(0);App.loader_elmt=$('<div class="loader"><span></span></div>');(Nav.view?Nav.view.$el:$("#wrapper")).append(App.loader_elmt.css({opacity:0}));App.loader_elmt.animate({opacity:1})},end_loading:function(b){App.loader_elmt&&
App.loader_elmt.animate({opacity:0},{complete:function(){App.loader_elmt.remove();App.loader_elmt=null;b&&b()}})},get_dates:function(b,a){for(var g=[],c=b;c<=a;)g.push(new Date(c)),c=c.addDays(1);return g},parse_date:function(b){return"function"==typeof Date.iso_date_parser?Date.iso_date_parser(b):Date.parse(b)},date:function(b,a){"string"==typeof b&&(b=App.parse_date(b));var g=new Date(b);return"January February March April May June July August September October November December".split(" ")[g.getMonth()]+
" "+App.ordinal_number(g.getDate())+" "+g.getFullYear()},ordinal_number:function(b){var a=["th","st","nd","rd"],g=b%100;return b+(a[(g-20)%10]||a[g]||a[0])},date_number:function(b){return 1==b.toString().length?"0"+b:b},get_position:function(b){navigator.geolocation?navigator.geolocation.getCurrentPosition(function(a){b({latitude:a.coords.latitude,longitude:a.coords.longitude})},function(a){b({latitude:null,longitude:null})}):b(!1)},authenticate_foursquare:function(){var b={client_id:App.params.foursquare.client_id,
response_type:"token",redirect_uri:window.location.href.split("#")[0]};window.location.href="https://foursquare.com/oauth2/authenticate?"+$.param(b)},intercept_foursquare_token:function(){if(-1<window.location.hash.indexOf("access_token")){var b=window.location.hash.split("#").reverse()[0].split("=").reverse()[0];window.localStorage&&window.localStorage.setItem("foursquare_token",b);window.location.replace("#recommend")}else window.localStorage&&window.localStorage.getItem("foursquare_token")&&(App.foursquare_token=
window.localStorage.getItem("foursquare_token"))}};Date.prototype.addDays=function(b){var a=new Date(this.valueOf());a.setDate(a.getDate()+b);return a};$.fn.prop=$.fn.prop||$.fn.attr;String.prototype.trim=function(){return this.replace(/^\s+/,"").replace(/\s+$/,"")};$(document).ready(function(){App.initialize()});
...
-1<_.indexOf(App.reply.timeslots[b.attr("data-day")],parseInt(b.attr("data-slot")))&&b.addClass("on")})},build_day:function(b){var a=$('<div class="day" />');a.append("<h3>"+App.date(b)+"</h3>");a.append('<ul class="availabilities" />');for(var g=0;24>g;g+=2)a.find("ul.availabilities").append('<li><a href="#" data-slot="'+g+'" data-day="'+b+'">'+g+"-"+(g+2)+"h</a></li>");return a},toggle:function(b,a){b=new Date(b);a=parseInt(a);var g=b.getFullYear()+"-"+App.date_number(b.getMonth()+1)+"-"+App.date_number(b.getDate());
App.reply.timeslots=App.reply.timeslots||{};App.reply.timeslots[g]=App.reply.timeslots[g]||[];-1==_.indexOf(App.reply.timeslots[g],a)?App.reply.timeslots[g].push(a):(App.reply.timeslots[g]=_(App.reply.timeslots[g]).without(a),0==App.reply.timeslots[g].length&&delete App.reply.timeslots[g]);App.save_reply()}});
...
this.$el.find("form.foursquare").on("submit",function(g){g.preventDefault();b.blur();a.run("refresh_places",[b.val()])})},unselect_all:function(){this.$el.find("div.current_location").removeClass("on").find("div.map").hide();this.$el.find("ul.places li").removeClass("selected")},current_location:function(){var b=this;App.get_position(function(a){a&&(a=new google.maps.LatLng(a.latitude,a.longitude),(new google.maps.Geocoder).geocode({latLng:a},function(g,c){c==google.maps.GeocoderStatus.OK&&0<g.length&&
b.use_current_location(g[1],a)}))})},use_current_location:function(b,a){this.unselect_all();this.$el.find("div.current_location a").text(b.formatted_address);var g=this.$el.find("div.map"),c=this;if(0==g.length){g=$('<div class="map" />');this.$el.find("div.current_location").append(g);var d=new google.maps.Map(g.get(0),{zoom:16,center:a,mapTypeId:google.maps.MapTypeId.ROADMAP}),f=new google.maps.Marker({position:a,map:d});google.maps.event.addListener(d,"center_changed",function(){var a=d.getCenter();
f.setPosition(a);c.update_location({latitude:a.lat(),longitude:a.lng()})})}else g.show();this.$el.find("div.current_location").addClass("on");this.update_location({latitude:a.lat(),longitude:a.lng()});Nav.run("resize")},use_place:function(b){this.unselect_all();b.parents("li").first().addClass("selected");b=this.places[b.attr("data-id")];this.update_location({latitude:b.location.lat,longitude:b.location.lng,foursquare:b})},update_location:function(b){App.reply.location=b;App.save_reply()},complete_meeting:function(){App.loader();
App.send_reply(function(){Nav.go("/complete","slide",{after_transition:function(){App.loader_elmt&&(App.loader_elmt.remove(),App.loader_elmt=null)}})})}});Views.complete=Backbone.View.extend({className:"complete",render:function(){this.$el.html($(Templates.complete).html());this.$el.find("strong").html(App.meeting.trip.name);return this},before_transition:function(){this.$el.find("a").link({run:function(b,a){b.preventDefault();alert("Feature coming soon.")}})}});
...
Views.recommend=Backbone.View.extend({className:"schedule",initialize:function(){App.foursquare_token||App.authenticate_foursquare();this.attach_behavior("place_selector")},render:function(){this.$el.html($(Templates.recommend).html());this.$el.find("strong").html(App.meeting.trip.name);return this},after_transition:function(){this.run("refresh_places",["",{}])}});
Behaviors.place_selector={initialize:function(){this.places={}},refresh_places:function(b,a){var g=this,c=$('<span class="bjr_loader"><span></span></span>');c.css({position:"absolute",top:160,left:"50%","margin-left":-14});this.$el.find("ul.places").empty().before(c);App.get_position(function(a){a={ll:a.latitude+","+a.longitude,v:"20130823"};App.foursquare_token?a.oauth_token=App.foursquare_token:(a.client_id=App.params.foursquare.client_id,a.client_secret="CAHKQWBRYE3W33VLHFNLAUEEMZJ5H124JDCXSPZW0SUORM0P");
b&&0<b.length&&(a.query=b);g.requests.push($.ajax({url:"https://api.foursquare.com/v2/venues/search",data:a,dataType:"json",success:function(a){a.response.venues&&0<a.response.venues.length&&g.run("display_places",[a.response.venues])}}))})},close_selector:function(b){var a=this.$el.find("form.status");a.css({position:"absolute",left:0,top:0,right:0}).show();b.css({position:"absolute"});Animation.move_element(b,{y:$(window).height(),end:function(){b.remove();a.css({position:"static"});Nav.run("resize");
var g=$("#above p.foursquare_powered");g.animate({opacity:0},{complete:function(){g.remove()}})}})},display_places:function(b){for(var a=this.$el.find("ul.places"),g=this,c=0;c<b.length;c++){var d=$('<li><a href="#" data-id="'+b[c].id+'"></a></li>');d.find("a").append("<strong>"+b[c].name+"</strong>").append("<span>"+this.behaviors.place_selector.foursquare_location(b[c])+"</span>");a.append(d);d.find("a").link({run:function(a){a.preventDefault();g.run("use_place",[this])}});this.places[b[c].id]=
b[c]}Nav.run("resize")},foursquare_location:function(b){var a="";b.location.address&&(a+=b.location.address+", ");b.location.postalCode&&(a+=b.location.postalCode+" ");b.location.city&&(a+=b.location.city);return a}};
