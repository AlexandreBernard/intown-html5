...
function p(e){return e.filter(function(e,a,b){return b.indexOf(e)==a})}function n(e){return e in B?B[e]:B[e]=RegExp("(^|\\s)"+e+"(\\s|$)")}function t(a,b){b===w&&y.test(a)&&RegExp.$1;b in e||(b="*");var g=e[b];g.innerHTML=""+a;return k.call(g.childNodes)}function r(e,a){e=e||x;e.__proto__=r.prototype;e.selector=a||"";return e}function m(e,a){if(!e)return r();if(a!==w)return m(a).find(e);if(b(e))return m(s).ready(e);if(e instanceof r)return e;var g;h(e)?g=d(e):0<=E.indexOf(e.nodeType)||e===window?
...
s(a,function(a,e,c){0==e?b[0]=a:(g=Math.floor(Math.random()*(e+1)),b[e]=b[g],b[g]=a)});return b};k.sortBy=function(a,b,g){return k.pluck(k.map(a,function(a,e,c){return{value:a,criteria:b.call(g,a,e,c)}}).sort(function(a,b){var e=a.criteria,g=b.criteria;return e<g?-1:e>g?1:0}),"value")};k.groupBy=function(a,b){var g={},c=k.isFunction(b)?b:function(a){return a[b]};s(a,function(a,b){var e=c(a,b);(g[e]||(g[e]=[])).push(a)});return g};k.sortedIndex=function(a,b,g){g||(g=k.identity);for(var c=0,d=a.length;c<
...
{});f=a.shift();)e=(h=d[f])?h.tail:{},e.next=k={},e.context=c,e.callback=b,d[f]={tail:k,next:h?h.next:e};return this},off:function(a,b,c){var d,k,e,h,l,m;if(k=this._callbacks){if(!a&&!b&&!c)return delete this._callbacks,this;for(a=a?a.split(p):f.keys(k);d=a.shift();)if(e=k[d],delete k[d],e&&(b||c))for(h=e.tail;(e=e.next)!==h;)if(l=e.callback,m=e.context,b&&l!==b||c&&m!==c)this.on(d,l,m);return this}},trigger:function(a){var b,c,d,f,e,k;if(!(d=this._callbacks))return this;e=d.all;a=a.split(p);for(k=
...
var Routes={routes:{complete:"complete",place:"place",schedule:"schedule","*actions":"invitation"}},Views={},Behaviors={},App={params:{os_offset:0},initialize:function(){"iPhone"==Env.device.device&&7>Env.device.version&&(this.params.os_offset=60);App.loader();Nav.initialize({remove_views:!1,no_access_animation:"slide",ui_delay:500})},after_initialize:function(){window.setTimeout(App.end_loading,800)},before_transition:function(){Nav.view.requests=[];App.resize();$.fn.placeholder&&Nav.view.$el.find("input[type=text], input[type=date], input[type=password], textarea").placeholder()},
...
"translate3d("+b+"px, "+a+"px, 0)":"translate("+b+"px, "+a+"px)"},reset_slider:function(){Nav.elmt.css({"-webkit-transition-timing-function":"ease-in","-webkit-transition-duration":"0ms","-webkit-transform":"none"})}};Views.invitation=Backbone.View.extend({className:"invitation",render:function(){this.$el.html($(Templates.invitation).html());return this},before_transition:function(){this.$el.find("p.start a").link({run:function(b,a){b.preventDefault();Nav.go(a,"slide")}})}});
