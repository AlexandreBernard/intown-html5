...
window.localStorage.getItem("meeting_"+b)?(App.meeting=JSON.parse(window.localStorage.getItem("meeting_"+b)),window.localStorage.getItem("reply_"+b)&&(App.reply=JSON.parse(window.localStorage.getItem("reply_"+b))),App.launch()):(App.loader(),App.api.request("get@meetings/"+b,{success:function(){App.save_meeting(this)}}))},save_meeting:function(b){200==b.code?(App.meeting=b.data,window.localStorage&&(window.localStorage.setItem("meeting_"+App.meeting.id,JSON.stringify(b.data)),window.localStorage.setItem("current_meeting",
