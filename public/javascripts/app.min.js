...
function p(e){return e.filter(function(e,a,g){return g.indexOf(e)==a})}function n(e){return e in C?C[e]:C[e]=RegExp("(^|\\s)"+e+"(\\s|$)")}function t(a,g){g===w&&y.test(a)&&RegExp.$1;g in e||(g="*");var b=e[g];b.innerHTML=""+a;return h.call(b.childNodes)}function r(e,a){e=e||x;e.__proto__=r.prototype;e.selector=a||"";return e}function m(e,a){if(!e)return r();if(a!==w)return m(a).find(e);if(b(e))return m(s).ready(e);if(e instanceof r)return e;var g;k(e)?g=d(e):0<=z.indexOf(e.nodeType)||e===window?
(g=[e],e=null):y.test(e)?(g=t(e.trim(),RegExp.$1),e=null):g=e.nodeType&&3==e.nodeType?[e]:E(s,e);return r(g,e)}function u(e,a){return a===w?m(e):m(e).filter(a)}function v(e,a,g,c){return b(a)?a.call(e,g,c):a}function q(e,a,g){var b=e%2?a:a.parentNode;b&&b.insertBefore(g,!e?a.nextSibling:1==e?b.firstChild:2==e?a:null)}function A(e,a){a(e);for(var g in e.childNodes)A(e.childNodes[g],a)}var w,B,E,D,x=[],h=x.slice,s=window.document,F={},C={},G=s.defaultView.getComputedStyle,g={"column-count":1,columns:1,
"font-weight":1,"line-height":1,opacity:1,"z-index":1,zoom:1},y=/^\s*<(\w+)[^>]*>/,z=[1,9,11],H=s.createElement("table"),J=s.createElement("tr"),e={tr:s.createElement("tbody"),tbody:H,thead:H,tfoot:H,td:J,th:J,"*":s.createElement("div")},I=/complete|loaded|interactive/,K=/^\.([\w-]+)$/,L=/^#([\w-]+)$/,M=/^[\w-]+$/;m.extend=function(e){h.call(arguments,1).forEach(function(a){for(B in a)e[B]=a[B]});return e};m.qsa=E=function(e,a){var g;return e===s&&L.test(a)?(g=e.getElementById(RegExp.$1))?[g]:x:h.call(K.test(a)?
e.getElementsByClassName(RegExp.$1):M.test(a)?e.getElementsByTagName(a):e.querySelectorAll(a))};m.isFunction=b;m.isObject=a;m.isArray=k;m.map=function(e,a){var g,b=[],d;if(c(e))for(d=0;d<e.length;d++)g=a(e[d],d),null!=g&&b.push(g);else for(d in e)g=a(e[d],d),null!=g&&b.push(g);return 0<b.length?[].concat.apply([],b):b};m.each=function(e,a){var g;if(c(e))for(g=0;g<e.length&&!1!==a(g,e[g]);g++);else for(g in e)if(!1===a(g,e[g]))break;return e};m.fn={forEach:x.forEach,reduce:x.reduce,push:x.push,indexOf:x.indexOf,
concat:x.concat,map:function(e){return m.map(this,function(a,g){return e.call(a,g,a)})},slice:function(){return m(h.apply(this,arguments))},ready:function(e){I.test(s.readyState)?e(m):s.addEventListener("DOMContentLoaded",function(){e(m)},!1);return this},get:function(e){return e===w?this:this[e]},size:function(){return this.length},remove:function(){return this.each(function(){null!=this.parentNode&&this.parentNode.removeChild(this)})},each:function(e){this.forEach(function(a,g){e.call(a,g,a)});
...
b(e.item)?h.call(e):m(e);this.forEach(function(e){0>g.indexOf(e)&&a.push(e)})}return m(a)},eq:function(e){return-1===e?this.slice(e):this.slice(e,+e+1)},first:function(){var e=this[0];return e&&!a(e)?e:m(e)},last:function(){var e=this[this.length-1];return e&&!a(e)?e:m(e)},find:function(e){var a;a=1==this.length?E(this[0],e):this.map(function(){return E(this,e)});return m(a)},closest:function(e,a){var g=this[0],b=E(a||s,e);for(b.length||(g=null);g&&0>b.indexOf(g);)g=g!==a&&g!==s&&g.parentNode;return m(g)},
parents:function(e){for(var a=[],g=this;0<g.length;)g=m.map(g,function(e){if((e=e.parentNode)&&e!==s&&0>a.indexOf(e))return a.push(e),e});return u(a,e)},parent:function(e){return u(p(this.pluck("parentNode")),e)},children:function(e){return u(this.map(function(){return h.call(this.children)}),e)},siblings:function(e){return u(this.map(function(e,a){return h.call(a.parentNode.children).filter(function(e){return e!==a})}),e)},empty:function(){return this.each(function(){this.innerHTML=""})},pluck:function(e){return this.map(function(){return this[e]})},
...
w:this[0].style[f(e)]||G(this[0],"").getPropertyValue(e);var b="";for(B in e)b+=l(B)+":"+("number"==typeof e[B]&&!g[l(B)]?e[B]+"px":e[B])+";";"string"==typeof e&&(b=l(e)+":"+("number"==typeof a&&!g[l(e)]?a+"px":a));return this.each(function(){this.style.cssText+=";"+b})},index:function(e){return e?this.indexOf(m(e)[0]):this.parent().children().indexOf(this[0])},hasClass:function(e){return 1>this.length?!1:n(e).test(this[0].className)},addClass:function(e){return this.each(function(a){D=[];var g=this.className;
v(this,e,a,g).split(/\s+/g).forEach(function(e){m(this).hasClass(e)||D.push(e)},this);D.length&&(this.className+=(g?" ":"")+D.join(" "))})},removeClass:function(e){return this.each(function(a){if(e===w)return this.className="";D=this.className;v(this,e,a,D).split(/\s+/g).forEach(function(e){D=D.replace(n(e)," ")});this.className=D.trim()})},toggleClass:function(e,a){return this.each(function(g){g=v(this,e,g,this.className);(a===w?!m(this).hasClass(g):a)?m(this).addClass(g):m(this).removeClass(g)})}};
...
["after","prepend","before","append"].forEach(function(e,g){m.fn[e]=function(e){var b=a(e)?e:t(e);if(!("length"in b)||b.nodeType)b=[b];if(1>b.length)return this;var c=this.length,d=1<c,y=2>g;return this.each(function(e,a){for(var I=0;I<b.length;I++){var f=b[y?b.length-I-1:I];A(f,function(e){null!=e.nodeName&&("SCRIPT"===e.nodeName.toUpperCase()&&(!e.type||"text/javascript"===e.type))&&window.eval.call(window,e.innerHTML)});d&&e<c-1&&(f=f.cloneNode(!0));q(g,a,f)}})};m.fn[g%2?e+"To":"insert"+(g?"Before":
...
f=c.complete,c=c.duration);c&&(c/=1E3);return this.anim(a,c,d,f)};b.fn.anim=function(c,d,n,t){var r,m={},u,v=this,q,A=b.fx.transitionEnd;d===a&&(d=0.4);b.fx.off&&(d=0);if("string"==typeof c)m[k+"animation-name"]=c,m[k+"animation-duration"]=d+"s",A=b.fx.animationEnd;else{for(u in c)f.test(u)?(r||(r=[]),r.push(u+"("+c[u]+")")):m[u]=c[u];r&&(m[k+"transform"]=r.join(" "));b.fx.off||(m[k+"transition"]="all "+d+"s "+(n||""))}q=function(){var a={};a[k+"transition"]=a[k+"animation-name"]="none";b(this).css(a);
t&&t.call(this)};if(0<d)this.one(A,q);setTimeout(function(){v.css(m);0>=d&&setTimeout(function(){v.each(function(){q.call(this)})},0)},0);return this};d=null})(Zepto);
...
l(c,d,f)}function l(c,d,f){var k=f.context;f.complete.call(k,d,c);a(f,k,"ajaxComplete",[d,f]);f.global&&!--b.active&&a(f,null,"ajaxStop")}function p(){}function n(a,c,d,f){var k=b.isArray(c);b.each(c,function(c,h){f&&(c=d?f:f+"["+(k?"":c)+"]");!f&&k?a.add(h.name,h.value):(d?b.isArray(h):r(h))?n(a,h,d,c):a.add(c,h)})}var t=0,r=b.isObject,m=window.document,u,v;b.active=0;b.ajaxJSONP=function(a){var c="jsonp"+ ++t,f=m.createElement("script"),k={abort:function(){b(f).remove();c in window&&(window[c]=
...
return b.ajax({type:"POST",url:a,data:c,success:d,dataType:f})};b.getJSON=function(a,c){return b.ajax({url:a,success:c,dataType:"json"})};b.fn.load=function(a,c){if(!this.length)return this;var d=this,f=a.split(/\s/),k;1<f.length&&(a=f[0],k=f[1]);b.get(a,function(a){d.html(k?b(m.createElement("div")).html(a).find(k).html():a);c&&c.call(d)});return this};var q=encodeURIComponent;b.param=function(a,b){var c=[];c.add=function(a,b){this.push(q(a)+"="+q(b))};n(c,a,b);return c.join("&").replace("%20","+")}})(Zepto);
...
(function(){function b(a,g,c){if(a===g)return 0!==a||1/a==1/g;if(null==a||null==g)return a===g;a._chain&&(a=a._wrapped);g._chain&&(g=g._wrapped);if(a.isEqual&&h.isFunction(a.isEqual))return a.isEqual(g);if(g.isEqual&&h.isFunction(g.isEqual))return g.isEqual(a);var d=n.call(a);if(d!=n.call(g))return!1;switch(d){case "[object String]":return a==String(g);case "[object Number]":return a!=+a?g!=+g:0==a?1/a==1/g:a==+g;case "[object Date]":case "[object Boolean]":return+a==+g;case "[object RegExp]":return a.source==
g.source&&a.global==g.global&&a.multiline==g.multiline&&a.ignoreCase==g.ignoreCase}if("object"!=typeof a||"object"!=typeof g)return!1;for(var f=c.length;f--;)if(c[f]==a)return!0;c.push(a);var f=0,y=!0;if("[object Array]"==d){if(f=a.length,y=f==g.length)for(;f--&&(y=f in a==f in g&&b(a[f],g[f],c)););}else{if("constructor"in a!="constructor"in g||a.constructor!=g.constructor)return!1;for(var z in a)if(h.has(a,z)&&(f++,!(y=h.has(g,z)&&b(a[z],g[z],c))))break;if(y){for(z in g)if(h.has(g,z)&&!f--)break;
y=!f}}c.pop();return y}var a=this,k=a._,c={},d=Array.prototype,f=Object.prototype,l=d.slice,p=d.unshift,n=f.toString,t=f.hasOwnProperty,r=d.forEach,m=d.map,u=d.reduce,v=d.reduceRight,q=d.filter,A=d.every,w=d.some,B=d.indexOf,E=d.lastIndexOf,f=Array.isArray,D=Object.keys,x=Function.prototype.bind,h=function(a){return new z(a)};"undefined"!==typeof exports?("undefined"!==typeof module&&module.exports&&(exports=module.exports=h),exports._=h):a._=h;h.VERSION="1.3.1";var s=h.each=h.forEach=function(a,
b,g){if(null!=a)if(r&&a.forEach===r)a.forEach(b,g);else if(a.length===+a.length)for(var d=0,f=a.length;d<f&&!(d in a&&b.call(g,a[d],d,a)===c);d++);else for(d in a)if(h.has(a,d)&&b.call(g,a[d],d,a)===c)break};h.map=h.collect=function(a,b,g){var c=[];if(null==a)return c;if(m&&a.map===m)return a.map(b,g);s(a,function(a,e,d){c[c.length]=b.call(g,a,e,d)});a.length===+a.length&&(c.length=a.length);return c};h.reduce=h.foldl=h.inject=function(a,b,g,c){var d=2<arguments.length;null==a&&(a=[]);if(u&&a.reduce===
u)return c&&(b=h.bind(b,c)),d?a.reduce(b,g):a.reduce(b);s(a,function(a,e,f){d?g=b.call(c,g,a,e,f):(g=a,d=!0)});if(!d)throw new TypeError("Reduce of empty array with no initial value");return g};h.reduceRight=h.foldr=function(a,b,g,c){var d=2<arguments.length;null==a&&(a=[]);if(v&&a.reduceRight===v)return c&&(b=h.bind(b,c)),d?a.reduceRight(b,g):a.reduceRight(b);var f=h.toArray(a).reverse();c&&!d&&(b=h.bind(b,c));return d?h.reduce(f,b,g,c):h.reduce(f,b)};h.find=h.detect=function(a,b,g){var c;F(a,function(a,
e,d){if(b.call(g,a,e,d))return c=a,!0});return c};h.filter=h.select=function(a,b,g){var c=[];if(null==a)return c;if(q&&a.filter===q)return a.filter(b,g);s(a,function(a,e,d){b.call(g,a,e,d)&&(c[c.length]=a)});return c};h.reject=function(a,b,g){var c=[];if(null==a)return c;s(a,function(a,e,d){b.call(g,a,e,d)||(c[c.length]=a)});return c};h.every=h.all=function(a,b,g){var d=!0;if(null==a)return d;if(A&&a.every===A)return a.every(b,g);s(a,function(a,e,f){if(!(d=d&&b.call(g,a,e,f)))return c});return d};
var F=h.some=h.any=function(a,b,g){b||(b=h.identity);var d=!1;if(null==a)return d;if(w&&a.some===w)return a.some(b,g);s(a,function(a,e,f){if(d||(d=b.call(g,a,e,f)))return c});return!!d};h.include=h.contains=function(a,b){var g=!1;return null==a?g:B&&a.indexOf===B?-1!=a.indexOf(b):g=F(a,function(a){return a===b})};h.invoke=function(a,b){var g=l.call(arguments,2);return h.map(a,function(a){return(h.isFunction(b)?b||a:a[b]).apply(a,g)})};h.pluck=function(a,b){return h.map(a,function(a){return a[b]})};
h.max=function(a,b,g){if(!b&&h.isArray(a))return Math.max.apply(Math,a);if(!b&&h.isEmpty(a))return-Infinity;var c={computed:-Infinity};s(a,function(a,e,d){e=b?b.call(g,a,e,d):a;e>=c.computed&&(c={value:a,computed:e})});return c.value};h.min=function(a,b,g){if(!b&&h.isArray(a))return Math.min.apply(Math,a);if(!b&&h.isEmpty(a))return Infinity;var c={computed:Infinity};s(a,function(a,e,d){e=b?b.call(g,a,e,d):a;e<c.computed&&(c={value:a,computed:e})});return c.value};h.shuffle=function(a){var b=[],g;
s(a,function(a,e,c){0==e?b[0]=a:(g=Math.floor(Math.random()*(e+1)),b[e]=b[g],b[g]=a)});return b};h.sortBy=function(a,b,g){return h.pluck(h.map(a,function(a,e,c){return{value:a,criteria:b.call(g,a,e,c)}}).sort(function(a,e){var b=a.criteria,g=e.criteria;return b<g?-1:b>g?1:0}),"value")};h.groupBy=function(a,b){var g={},c=h.isFunction(b)?b:function(a){return a[b]};s(a,function(a,e){var b=c(a,e);(g[b]||(g[b]=[])).push(a)});return g};h.sortedIndex=function(a,b,g){g||(g=h.identity);for(var c=0,d=a.length;c<
d;){var f=c+d>>1;g(a[f])<g(b)?c=f+1:d=f}return c};h.toArray=function(a){return!a?[]:a.toArray?a.toArray():h.isArray(a)||h.isArguments(a)?l.call(a):h.values(a)};h.size=function(a){return h.toArray(a).length};h.first=h.head=function(a,b,g){return null!=b&&!g?l.call(a,0,b):a[0]};h.initial=function(a,b,g){return l.call(a,0,a.length-(null==b||g?1:b))};h.last=function(a,b,g){return null!=b&&!g?l.call(a,Math.max(a.length-b,0)):a[a.length-1]};h.rest=h.tail=function(a,b,g){return l.call(a,null==b||g?1:b)};
h.compact=function(a){return h.filter(a,function(a){return!!a})};h.flatten=function(a,b){return h.reduce(a,function(a,g){if(h.isArray(g))return a.concat(b?g:h.flatten(g));a[a.length]=g;return a},[])};h.without=function(a){return h.difference(a,l.call(arguments,1))};h.uniq=h.unique=function(a,b,g){g=g?h.map(a,g):a;var c=[];h.reduce(g,function(g,d,f){if(0==f||(!0===b?h.last(g)!=d:!h.include(g,d)))g[g.length]=d,c[c.length]=a[f];return g},[]);return c};h.union=function(){return h.uniq(h.flatten(arguments,
!0))};h.intersection=h.intersect=function(a){var b=l.call(arguments,1);return h.filter(h.uniq(a),function(a){return h.every(b,function(b){return 0<=h.indexOf(b,a)})})};h.difference=function(a){var b=h.flatten(l.call(arguments,1));return h.filter(a,function(a){return!h.include(b,a)})};h.zip=function(){for(var a=l.call(arguments),b=h.max(h.pluck(a,"length")),g=Array(b),c=0;c<b;c++)g[c]=h.pluck(a,""+c);return g};h.indexOf=function(a,b,g){if(null==a)return-1;var c;if(g)return g=h.sortedIndex(a,b),a[g]===
b?g:-1;if(B&&a.indexOf===B)return a.indexOf(b);g=0;for(c=a.length;g<c;g++)if(g in a&&a[g]===b)return g;return-1};h.lastIndexOf=function(a,b){if(null==a)return-1;if(E&&a.lastIndexOf===E)return a.lastIndexOf(b);for(var g=a.length;g--;)if(g in a&&a[g]===b)return g;return-1};h.range=function(a,b,g){1>=arguments.length&&(b=a||0,a=0);g=arguments[2]||1;for(var c=Math.max(Math.ceil((b-a)/g),0),d=0,f=Array(c);d<c;)f[d++]=a,a+=g;return f};var C=function(){};h.bind=function(a,b){var g,c;if(a.bind===x&&x)return x.apply(a,
l.call(arguments,1));if(!h.isFunction(a))throw new TypeError;c=l.call(arguments,2);return g=function(){if(!(this instanceof g))return a.apply(b,c.concat(l.call(arguments)));C.prototype=a.prototype;var d=new C,f=a.apply(d,c.concat(l.call(arguments)));return Object(f)===f?f:d}};h.bindAll=function(a){var b=l.call(arguments,1);0==b.length&&(b=h.functions(a));s(b,function(b){a[b]=h.bind(a[b],a)});return a};h.memoize=function(a,b){var g={};b||(b=h.identity);return function(){var c=b.apply(this,arguments);
return h.has(g,c)?g[c]:g[c]=a.apply(this,arguments)}};h.delay=function(a,b){var g=l.call(arguments,2);return setTimeout(function(){return a.apply(a,g)},b)};h.defer=function(a){return h.delay.apply(h,[a,1].concat(l.call(arguments,1)))};h.throttle=function(a,b){var g,c,d,f,y,z=h.debounce(function(){y=f=!1},b);return function(){g=this;c=arguments;d||(d=setTimeout(function(){d=null;y&&a.apply(g,c);z()},b));f?y=!0:a.apply(g,c);z();f=!0}};h.debounce=function(a,b){var g;return function(){var c=this,d=arguments;
clearTimeout(g);g=setTimeout(function(){g=null;a.apply(c,d)},b)}};h.once=function(a){var b=!1,g;return function(){if(b)return g;b=!0;return g=a.apply(this,arguments)}};h.wrap=function(a,b){return function(){var g=[a].concat(l.call(arguments,0));return b.apply(this,g)}};h.compose=function(){var a=arguments;return function(){for(var b=arguments,g=a.length-1;0<=g;g--)b=[a[g].apply(this,b)];return b[0]}};h.after=function(a,b){return 0>=a?b():function(){if(1>--a)return b.apply(this,arguments)}};h.keys=
D||function(a){if(a!==Object(a))throw new TypeError("Invalid object");var b=[],g;for(g in a)h.has(a,g)&&(b[b.length]=g);return b};h.values=function(a){return h.map(a,h.identity)};h.functions=h.methods=function(a){var b=[],g;for(g in a)h.isFunction(a[g])&&b.push(g);return b.sort()};h.extend=function(a){s(l.call(arguments,1),function(b){for(var g in b)a[g]=b[g]});return a};h.defaults=function(a){s(l.call(arguments,1),function(b){for(var g in b)null==a[g]&&(a[g]=b[g])});return a};h.clone=function(a){return!h.isObject(a)?
a:h.isArray(a)?a.slice():h.extend({},a)};h.tap=function(a,b){b(a);return a};h.isEqual=function(a,g){return b(a,g,[])};h.isEmpty=function(a){if(h.isArray(a)||h.isString(a))return 0===a.length;for(var b in a)if(h.has(a,b))return!1;return!0};h.isElement=function(a){return!!(a&&1==a.nodeType)};h.isArray=f||function(a){return"[object Array]"==n.call(a)};h.isObject=function(a){return a===Object(a)};h.isArguments=function(a){return"[object Arguments]"==n.call(a)};h.isArguments(arguments)||(h.isArguments=
...
function(a){return void 0===a};h.has=function(a,b){return t.call(a,b)};h.noConflict=function(){a._=k;return this};h.identity=function(a){return a};h.times=function(a,b,g){for(var c=0;c<a;c++)b.call(g,c)};h.escape=function(a){return(""+a).replace(/&/g,"&amp;").replace(/</g,"&lt;").replace(/>/g,"&gt;").replace(/"/g,"&quot;").replace(/'/g,"&#x27;").replace(/\//g,"&#x2F;")};h.mixin=function(a){s(h.functions(a),function(b){J(b,h[b]=a[b])})};var G=0;h.uniqueId=function(a){var b=G++;return a?a+b:b};h.templateSettings=
...
b){return"');"+y(b).replace(/[\r\n\t]/g," ")+";__p.push('"}).replace(/\r/g,"\\r").replace(/\n/g,"\\n").replace(/\t/g,"\\t")+"');}return __p.join('');",d=new Function("obj","_",c);return b?d(b,h):function(a){return d.call(this,a,h)}};h.chain=function(a){return h(a).chain()};var z=function(a){this._wrapped=a};h.prototype=z.prototype;var H=function(a,b){return b?h(a).chain():a},J=function(a,b){z.prototype[a]=function(){var a=l.call(arguments);p.call(a,this._wrapped);return H(b.apply(h,a),this._chain)}};
h.mixin(h);s("pop push reverse shift sort splice unshift".split(" "),function(a){var b=d[a];z.prototype[a]=function(){var g=this._wrapped;b.apply(g,arguments);var c=g.length;("shift"==a||"splice"==a)&&0===c&&delete g[0];return H(g,this._chain)}});s(["concat","join","slice"],function(a){var b=d[a];z.prototype[a]=function(){return H(b.apply(this._wrapped,arguments),this._chain)}});z.prototype.chain=function(){this._chain=!0;return this};z.prototype.value=function(){return this._wrapped}}).call(this);
(function(){var b=this,a=b.Backbone,k=Array.prototype.slice,c=Array.prototype.splice,d;d="undefined"!==typeof exports?exports:b.Backbone={};d.VERSION="0.9.2";var f=b._;!f&&"undefined"!==typeof require&&(f=require("underscore"));var l=b.jQuery||b.Zepto||b.ender;d.setDomLibrary=function(a){l=a};d.noConflict=function(){b.Backbone=a;return this};d.emulateHTTP=!1;d.emulateJSON=!1;var p=/\s+/,n=d.Events={on:function(a,b,c){var d,f,e,h,k;if(!b)return this;a=a.split(p);for(d=this._callbacks||(this._callbacks=
{});f=a.shift();)e=(k=d[f])?k.tail:{},e.next=h={},e.context=c,e.callback=b,d[f]={tail:h,next:k?k.next:e};return this},off:function(a,b,c){var d,h,e,k,l,m;if(h=this._callbacks){if(!a&&!b&&!c)return delete this._callbacks,this;for(a=a?a.split(p):f.keys(h);d=a.shift();)if(e=h[d],delete h[d],e&&(b||c))for(k=e.tail;(e=e.next)!==k;)if(l=e.callback,m=e.context,b&&l!==b||c&&m!==c)this.on(d,l,m);return this}},trigger:function(a){var b,c,d,f,e,h;if(!(d=this._callbacks))return this;e=d.all;a=a.split(p);for(h=
k.call(arguments,1);b=a.shift();){if(c=d[b])for(f=c.tail;(c=c.next)!==f;)c.callback.apply(c.context||this,h);if(c=e){f=c.tail;for(b=[b].concat(h);(c=c.next)!==f;)c.callback.apply(c.context||this,b)}}return this}};n.bind=n.on;n.unbind=n.off;var t=d.Model=function(a,b){var c;a||(a={});b&&b.parse&&(a=this.parse(a));if(c=C(this,"defaults"))a=f.extend({},c,a);b&&b.collection&&(this.collection=b.collection);this.attributes={};this._escapedAttributes={};this.cid=f.uniqueId("c");this.changed={};this._silent=
...
b?"":""+b)},has:function(a){return null!=this.get(a)},set:function(a,b,c){var d,h;f.isObject(a)||null==a?(d=a,c=b):(d={},d[a]=b);c||(c={});if(!d)return this;d instanceof t&&(d=d.attributes);if(c.unset)for(h in d)d[h]=void 0;if(!this._validate(d,c))return!1;this.idAttribute in d&&(this.id=d[this.idAttribute]);b=c.changes={};var e=this.attributes,k=this._escapedAttributes,l=this._previousAttributes||{};for(h in d){a=d[h];if(!f.isEqual(e[h],a)||c.unset&&f.has(e,h))delete k[h],(c.silent?this._silent:
...
a.error=d.wrapError(a.error,b,a);return(this.sync||d.sync).call(this,"read",this,a)},save:function(a,b,c){var h,k;f.isObject(a)||null==a?(h=a,c=b):(h={},h[a]=b);c=c?f.clone(c):{};if(c.wait){if(!this._validate(h,c))return!1;k=f.clone(this.attributes)}a=f.extend({},c,{silent:!0});if(h&&!this.set(h,c.wait?a:c))return!1;var e=this,l=c.success;c.success=function(a,b,g){b=e.parse(a,g);c.wait&&(delete c.wait,b=f.extend(h||{},b));if(!e.set(b,c))return!1;l?l(e,a):e.trigger("sync",e,a,c)};c.error=d.wrapError(c.error,
e,c);b=this.isNew()?"create":"update";b=(this.sync||d.sync).call(this,b,this,c);c.wait&&this.set(k,a);return b},destroy:function(a){a=a?f.clone(a):{};var b=this,c=a.success,h=function(){b.trigger("destroy",b,b.collection,a)};if(this.isNew())return h(),!1;a.success=function(d){a.wait&&h();c?c(b,d):b.trigger("sync",b,d,a)};a.error=d.wrapError(a.error,b,a);var k=(this.sync||d.sync).call(this,"delete",this,a);a.wait||h();return k},url:function(){var a=C(this,"urlRoot")||C(this.collection,"url")||G();
...
this._reset();this.initialize.apply(this,arguments);a&&this.reset(a,{silent:!0,parse:b.parse})};f.extend(r.prototype,n,{model:t,initialize:function(){},toJSON:function(a){return this.map(function(b){return b.toJSON(a)})},add:function(a,b){var d,h,k,e,l,m={},q={},p=[];b||(b={});a=f.isArray(a)?a.slice():[a];d=0;for(h=a.length;d<h;d++){if(!(k=a[d]=this._prepareModel(a[d],b)))throw Error("Can't add an invalid model to a collection");e=k.cid;l=k.id;m[e]||this._byCid[e]||null!=l&&(q[l]||this._byId[l])?
p.push(d):m[e]=q[l]=k}for(d=p.length;d--;)a.splice(p[d],1);d=0;for(h=a.length;d<h;d++)(k=a[d]).on("all",this._onModelEvent,this),this._byCid[k.cid]=k,null!=k.id&&(this._byId[k.id]=k);this.length+=h;c.apply(this.models,[null!=b.at?b.at:this.models.length,0].concat(a));this.comparator&&this.sort({silent:!0});if(b.silent)return this;d=0;for(h=this.models.length;d<h;d++)if(m[(k=this.models[d]).cid])b.index=d,k.trigger("add",k,this,b);return this},remove:function(a,b){var c,d,h,e;b||(b={});a=f.isArray(a)?
...
v=/\*\w+/g,q=/[-[\]{}()+?.,\\^$|#\s]/g;f.extend(m.prototype,n,{initialize:function(){},route:function(a,b,c){d.history||(d.history=new A);f.isRegExp(a)||(a=this._routeToRegExp(a));c||(c=this[b]);d.history.route(a,f.bind(function(f){f=this._extractParameters(a,f);c&&c.apply(this,f);this.trigger.apply(this,["route:"+b].concat(f));d.history.trigger("route",this,b,f)},this));return this},navigate:function(a,b){d.history.navigate(a,b)},_bindRoutes:function(){if(this.routes){var a=[],b;for(b in this.routes)a.unshift([b,
this.routes[b]]);b=0;for(var c=a.length;b<c;b++)this.route(a[b][0],a[b][1],this[a[b][1]])}},_routeToRegExp:function(a){a=a.replace(q,"\\$&").replace(u,"([^/]+)").replace(v,"(.*?)");return RegExp("^"+a+"$")},_extractParameters:function(a,b){return a.exec(b).slice(1)}});var A=d.History=function(){this.handlers=[];f.bindAll(this,"checkUrl")},w=/^[#\/]/,B=/msie [\w.]+/;A.started=!1;f.extend(A.prototype,n,{interval:50,getHash:function(a){return(a=(a?a.location:window.location).href.match(/#(.*)$/))?a[1]:
""},getFragment:function(a,b){if(null==a)if(this._hasPushState||b){a=window.location.pathname;var c=window.location.search;c&&(a+=c)}else a=this.getHash();a.indexOf(this.options.root)||(a=a.substr(this.options.root.length));return a.replace(w,"")},start:function(a){if(A.started)throw Error("Backbone.history has already been started");A.started=!0;this.options=f.extend({},{root:"/"},this.options,a);this._wantsHashChange=!1!==this.options.hashChange;this._wantsPushState=!!this.options.pushState;this._hasPushState=
!(!this.options.pushState||!window.history||!window.history.pushState);a=this.getFragment();var b=document.documentMode;if(b=B.exec(navigator.userAgent.toLowerCase())&&(!b||7>=b))this.iframe=l('<iframe src="javascript:0" tabindex="-1" />').hide().appendTo("body")[0].contentWindow,this.navigate(a);this._hasPushState?l(window).bind("popstate",this.checkUrl):this._wantsHashChange&&"onhashchange"in window&&!b?l(window).bind("hashchange",this.checkUrl):this._wantsHashChange&&(this._checkUrlInterval=setInterval(this.checkUrl,
...
stop:function(){l(window).unbind("popstate",this.checkUrl).unbind("hashchange",this.checkUrl);clearInterval(this._checkUrlInterval);A.started=!1},route:function(a,b){this.handlers.unshift({route:a,callback:b})},checkUrl:function(a){a=this.getFragment();a==this.fragment&&this.iframe&&(a=this.getFragment(this.getHash(this.iframe)));if(a==this.fragment)return!1;this.iframe&&this.navigate(a);this.loadUrl()||this.loadUrl(this.getHash())},loadUrl:function(a){var b=this.fragment=this.getFragment(a);return f.any(this.handlers,
function(a){if(a.route.test(b))return a.callback(b),!0})},navigate:function(a,b){if(!A.started)return!1;if(!b||!0===b)b={trigger:b};var c=(a||"").replace(w,"");this.fragment!=c&&(this._hasPushState?(0!=c.indexOf(this.options.root)&&(c=this.options.root+c),this.fragment=c,window.history[b.replace?"replaceState":"pushState"]({},document.title,c)):this._wantsHashChange?(this.fragment=c,this._updateHash(window.location,c,b.replace),this.iframe&&c!=this.getFragment(this.getHash(this.iframe))&&(b.replace||
this.iframe.document.open().close(),this._updateHash(this.iframe.location,c,b.replace))):window.location.assign(this.options.root+a),b.trigger&&this.loadUrl(a))},_updateHash:function(a,b,c){c?a.replace(a.toString().replace(/(javascript:|#).*$/,"")+"#"+b):a.hash=b}});var E=d.View=function(a){this.cid=f.uniqueId("view");this._configure(a||{});this._ensureElement();this.initialize.apply(this,arguments);this.delegateEvents()},D=/^(\S+)\s*(.*)$/,x="model collection el id attributes className tagName".split(" ");
...
for(var b in a){var c=a[b];f.isFunction(c)||(c=this[a[b]]);if(!c)throw Error('Method "'+a[b]+'" does not exist');var d=b.match(D),h=d[1],d=d[2],c=f.bind(c,this),h=h+(".delegateEvents"+this.cid);""===d?this.$el.bind(h,c):this.$el.delegate(d,h,c)}}},undelegateEvents:function(){this.$el.unbind(".delegateEvents"+this.cid)},_configure:function(a){this.options&&(a=f.extend({},this.options,a));for(var b=0,c=x.length;b<c;b++){var d=x[b];a[d]&&(this[d]=a[d])}this.options=a},_ensureElement:function(){if(this.el)this.setElement(this.el,
!1);else{var a=C(this,"attributes")||{};this.id&&(a.id=this.id);this.className&&(a["class"]=this.className);this.setElement(this.make(this.tagName,a),!1)}}});t.extend=r.extend=m.extend=E.extend=function(a,b){var c=F(this,a,b);c.extend=this.extend;return c};var h={create:"POST",update:"PUT","delete":"DELETE",read:"GET"};d.sync=function(a,b,c){var k=h[a];c||(c={});var m={type:k,dataType:"json"};c.url||(m.url=C(b,"url")||G());if(!c.data&&b&&("create"==a||"update"==a))m.contentType="application/json",
...
Views.schedule=Backbone.View.extend({className:"schedule",initialize:function(){this.attach_behavior("place_selector")},render:function(){this.$el.html($(Templates.schedule).html());for(var b=["October 26th 2013","October 27th 2013"],a=0;a<b.length;a++){var k=this.build_day(b[a]);this.init_day(k);this.$el.find("div.days").append(k)}return this},build_day:function(b){var a=$('<div class="day" />');a.append("<h3>"+b+"</h3>");a.append('<ul class="availabilities" />');for(b=0;24>b;b+=2)a.find("ul.availabilities").append('<li><a href="#" data-slot="'+
b+'">'+b+"-"+(b+2)+"h</a></li>");return a},init_day:function(b){b.find("a").link({run:function(a){a.preventDefault();this.toggleClass("on")}})}});
